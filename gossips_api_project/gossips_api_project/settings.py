"""
Django settings for gossips_api_project project.
...
ROOT_URLCONF = 'gossips_api_project.urls'
...
AUTH_USER_MODEL = 'Accounts.gossips_account'

WSGI_APPLICATION = 'gossips_api_project.wsgi.application'
